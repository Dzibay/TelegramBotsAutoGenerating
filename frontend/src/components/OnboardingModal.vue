  ...
  <div v-if="open" class="onboarding-backdrop" role="dialog" aria-modal="true" aria-labelledby="onb-title">
    <div class="onboarding card">
      ...
      <ol class="onb-steps">
        ...
        <li>
          <strong>В кампании</strong> — добавьте подготовленные аккаунты и нажмите «Проверить все».
        </li>
        <li>
          <strong>Боты</strong> — создайте по одному (вручную или через AI) или списком. Ключевая фраза нужна
          только для генерации текстов нейросетью.
        </li>
      </ol>
